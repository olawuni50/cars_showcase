        ...
        <div className="search-manufacturer">
            <Combobox value={manufacturer} onChange={setManufacturer}>
                <div className="relative w-full">
                    ...
                    <Combobox.Input className="search-manufacturer__input" placeholder="Volkswagon" displayValue={(manufacturer: string) => manufacturer}
                    ...
                    leaveTo="opacity-0" afterLeave={() =>setQuery( '')}>
                        ...
                        <Combobox.Options>
                             {filteredManufacturers.map((item) => (
                                    ...
                                    ${active ? 'bg-primary-blue text-white': 'text-gray-900'}`} value={item}>
